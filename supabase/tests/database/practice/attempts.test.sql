...
insert into public.attempts (id, account_id, learner_id, word_id, target_type, score, phonemes) values
  ('a0000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'ee000000-0000-0000-0000-000000000001', 'word', 85,
   '[{"word": "apple", "phone": "ae", "quality_score": 90, "sound_most_like": "ae", "is_correct": true}]'::jsonb);

insert into public.attempts (id, account_id, learner_id, word_id, target_type, score, phonemes) values
  ('a0000000-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'ee000000-0000-0000-0000-000000000001', 'word', 60,
...
select throws_ok(
  $$insert into public.attempts (account_id, learner_id, word_id, target_type, score, phonemes)
    values ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'ee000000-0000-0000-0000-000000000001', 'word', 90, '[]'::jsonb)$$,
  '42501',
  null,
...
select throws_ok(
  $$insert into public.attempts (account_id, learner_id, word_id, target_type, score, phonemes)
    values ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'ee000000-0000-0000-0000-000000000001', 'invalid', 80, '[]'::jsonb)$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.attempts (account_id, learner_id, word_id, target_type, score, phonemes)
    values ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'ee000000-0000-0000-0000-000000000001', 'sentence', 80, '[]'::jsonb)$$,
  '23514',
  null,
...
select throws_ok(
  $$insert into public.attempts (account_id, learner_id, word_id, target_type, score, target_word_score, phonemes)
    values ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'ee000000-0000-0000-0000-000000000001', 'word', 80, 85, '[]'::jsonb)$$,
  '23514',
  null,
...
-- Test 8: phonemes JSONB is stored and retrievable
select is(
...
-- Test 9: phonemes JSONB preserves word field
select is(
...
-- Test 10: phonemes JSONB preserves is_correct boolean
select is(
